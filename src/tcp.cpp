...
int Raw::Server::sv_host(const char* laddr, const char* lport)
{
  return 0;
}

int Raw::Server::sv_close()
{
  return 0;
}

int Raw::Server::sv_cycle(const char* laddr, const char* rport,
													int timeout)
{
  return 0;
}

int Raw::Server::sv_recv(char rmsg[])
{
  return 0;
}

int Raw::Server::sv_send(const char* lmsg)
{
  return 0;
}
